...
# function that shifts frequency of a band-passed signal (whitens the data)   
...
#function that plots the results of the detectors
def plot_functions(time, timemax, SNR, pcolor, eventname, det, plottype, tevent, strain_whitenbp, template_match, template_fft,datafreq, d_eff, freqs, data_psd, fs):
    # -- Plot the result
